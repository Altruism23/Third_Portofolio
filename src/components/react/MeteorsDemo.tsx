  ...
  return (
    <div className="w-full h-screen">
      <div className=" w-full h-screen relative">
        ...
        <div className="relative shadow-xl bg-black px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col items-start">
          <div className="flex justify-center items-center text-center w-full py-5">
            <p className="text-white text-6xl">About Me</p>
          </div>
          <div className="flex max-md:flex-col max-md:justify-normal justify-between w-full h-full">
            <div className="max-w-3xl text-wrap text-justify leading-8 indent-12 p-10">
              <TextGenerateEffect filter={false} duration={0.5} words={words1} />
